...
// import { getLimitLineCss } from "sevago-sso-fe";

// export interface TextFieldSelectSearchObjectElementProps
...
// export const TextFieldSelectSearchObjectElement: React.FC<
//   TextFieldSelectSearchObjectElementProps
// > = ({
//   name,
//   openTest = false,
//   label,
...
//                 avatar={
//                   showAvatar ? (
//                     <AvatarElement url={option.url} alt={option.label} />
//                   ) : undefined
//                 }
//                 label={
//                   getOptionLabel
...
//         renderTags={
//           renderTags ||
//           ((tagValue, getTagProps) => customRenderTags(tagValue, getTagProps))
//         }
...
//                           <span
//                             key={index}
//                             style={{ color: index > 0 ? "gray" : "inherit" }}
//                           >
//                             {part}
