...
export const login = createAsyncThunk(
  "LOGIN",
  async (params: LoginDto, { rejectWithValue }) => {
    try {
...
export const logout = createAsyncThunk(
  "LOGOUT",
  async (params: LogoutDto, { rejectWithValue }) => {
    try {
...
export const refreshToken = createAsyncThunk(
  "REFRESH_TOKEN",
  async (params: RefreshTokenDto, { rejectWithValue }) => {
    try {
...
export const updatePositionOrgUnit = createAsyncThunk(
  "UPDATE_POSITION_ORG_UNIT",
  (userUnitPositionId: string) => {
    return userUnitPositionId;
  }
);

export const updateCurrentAccess = createAsyncThunk(
